	...
	<div class="cms-content-header north">
		...
		<div class="cms-content-header-tabs">
			...
			<div class="icon-button-group">
				...
				<% loop $Tabs %>
					<li<% if $extraClass %> class="$extraClass"<% end_if %>><a class="cms-panel-link icon-button <% if $Title == 'List View' %>font-icon-list<% else_if $Title == 'Gallery View' %>font-icon-thumbnails<% else %>font-icon-pencil<% end_if %>" href="#$id" title="$Title"></a></li>
				<% end_loop %>
				</ul>
			</div>
		</div>
